...
for q in apihooks callbacks connections connscan cmdline cmdscan clipboard consoles dlllist driverirp drivermodule driverscan getsids idt iehistory handles hivelist hivescan imageinfo ldrmodules modscan modules psxview schtasks shellbags sockscan ssdt; do 
